    ...
    <div class="text-center">
        ...
        <div class="bg-white shadow-lg p-8 mb-4">
            ...
            <div class="flex flex-col w-full md:w-1/2 md:mx-auto">
                ...
                <a href="${pageContext.request.contextPath}/logout" class="dashboard-button bg-red-500 hover:bg-red-600 text-white font-bold py-3 px-6 transition duration-300 ease-in-out text-center">Sign Out</a>
            </div>
        </div>
    </div>
</div>
